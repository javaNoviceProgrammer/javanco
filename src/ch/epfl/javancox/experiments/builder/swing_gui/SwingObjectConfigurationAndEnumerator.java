...
//				tree = new HouseMadeTree<X>(ObjectConstuctionTreeModel.loadFromFile(classRepo, clas, fileChooser.getSelectedFile().getAbsolutePath()));
				//********* modified by meisam ***********************
				...
				Runnable r = new Runnable() {
					...
					public void run() {
						if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
						  ...
						  show(file.getAbsolutePath(), false);
						}
					}
				};
	...
	public void show(String file, boolean systemExit) {
		logger.info("Loading initial interface (can take time...)");
		try {
			isReadyLabel = new JLabel("Not ready");

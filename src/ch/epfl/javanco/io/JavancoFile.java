...
//		System.setProperty(Javanco.JAVANCO_LAUNCH_DIR_PROPERTY,System.getProperty("user.dir"));
	...
	public static boolean graphExists(String string) {
		...
		return findFile(string, JavancoFile.getDefaultMNDfilesDir()).exists();
	}
	...
	public static JavancoFile findFile(String fileName, String dirName) {
		...
		JavancoFile ret = new JavancoFile(dirName + File.separator + fileName);
		return ret;
	}
	...
	public static JavancoFile findFile(String pathRelativeToJavancoHome) throws Exception {
		...
		JavancoFile ret = new JavancoFile(findRessource(pathRelativeToJavancoHome).toURI());
		return ret;
	}
	...
	public static String getDefaultMNDfilesDir() {
		...
		String[] locations = {"ch.epfl.javanco.xmlFilesDir", "ch.epfl.javanco.startDir", "user.dir"};
	...
	public static String getDefaultGroovyScriptDir() {
		...
		String[] locations = {"ch.epfl.javanco.groovyScriptsDir", "ch.epfl.javanco.startDir", "user.dir"};
		return internalGetDir(locations);
	}
	...
	/*	public static JavancoFile getDefaultOutputDir() {
		return new JavancoFile("output/");
	}*/
